...
import io.github.cursodsousa.msavaliadorcredito.application.domain.model.*;
...
public class AvaliadorCreditoService {
    ...
    public SituacaoCliente obterSituacaoCliente(String cpf) throws  DadosClienteNotFoundException, ErroComunicacaoMicroservicesException{
        ...
        try{
        ResponseEntity<DadosCliente> dadosClienteResponse = clientesCliente.dadosCliente(cpf);
    ...
    public RetornoAvaliacaoCliente realizarAvaliacao(String cpf, Long renda)
        ...
        try{
            ResponseEntity<DadosCliente> dadosClienteResponseEntity = clientesCliente.dadosCliente(cpf);
            ResponseEntity<List<Cartao>> cartoesResponse = cartoesCliente.getCartoesRendaAte(renda);
